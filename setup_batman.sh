...
# Configures batman-adv, creates virtual TAP interface, and clamps MTU for LoRa.
# ==============================================================================
...
if [ "$EUID" -ne 0 ]; then
  echo "[ERROR] Please run as root (e.g., sudo ./setup_batman.sh)" >&2
  exit 1
fi
...
echo "Clamped MTU: ${RADIO_MTU} bytes (Optimized for LoRa 255B PHY)"
echo "============================================================"
...
# Set MTU on the radio TAP interface to fit LoRa physical payload
